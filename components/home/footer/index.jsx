import { View, Text, TouchableNativeFeedback, Platform, TouchableOpacity } from 'react-native'
  ...
  return (
    <View style={styles.container}>
      <TabTouchable
        ...
        background={Platform.OS === 'android' ? TouchableNativeFeedback.Ripple('#216397') : null}
      >
